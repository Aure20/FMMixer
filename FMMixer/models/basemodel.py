...
from FMMixer.inputs import build_input_features, SparseFeat, DenseFeat, create_embedding_matrix
from .pred_layer import PredictionLayer
from .utils import slice_arrays
from FMMixer.callbacks import History


class Linear(nn.Module):
    def __init__(self, feature_columns, feature_index, init_std=0.0001, device='cpu', model_name = 'None'):
...
class BaseModel(nn.Module):
    ...
    def fit(self, x=None, y=None, batch_size=None, epochs=1, verbose=1, initial_epoch=0, validation_split=0.,
        ...
        callbacks.model.stop_training = True #Set to False to remove early stopping
    ...
    #Separate in X the sparse and dense features and then create the embedding matrix for all the features
    ...
    #Get input dimension for the DNN
